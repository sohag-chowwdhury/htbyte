...
export const socialMediaProfiles = [
  {
    title: 'Facebook',
    href: 'https://www.facebook.com/people/HTByte/61559793028088/?sk',
    icon: FacebookIcon,
  },
  { title: 'X', href: 'https://x.com/HtbyteDev', icon: InstagramIcon },
  { title: 'GitHub', href: 'https://github.com/HTByte', icon: GitHubIcon },
  {
    title: 'Dribbble',
    href: 'https://dribbble.com/HTByte',
    icon: DribbbleIcon,
  },
  {
    title: 'Linkedin',
    href: 'https://linkedin.com/company/htbyte',
    icon: DribbbleIcon,
  },
]
